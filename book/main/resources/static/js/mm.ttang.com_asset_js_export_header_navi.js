//document.write('<script type="text/javascript" src="'+v_mobile_domain_name+'/asset/js/dev/common/pub_navi.js"></script>');
document.write('<script language="javascript" src="'+v_mobile_domain_name+'/common/headerNavi.do"></script>');
$(function(){
	/* navigation */
